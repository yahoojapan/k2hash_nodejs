...
if [ -z "${CI_OSTYPE}" ]; then
	...
	INSTALL_PKG_LIST="git gcc g++ make procps ca-certificates gnupg k2hash-dev"
	...
	INSTALL_AUTO_ARG="-y"
	INSTALL_QUIET_ARG="-q"
	INSTALL_PKG_LIST="git gcc gcc-c++ make procps xz k2hash-devel"
	NODEJS_PKG_LIST="nodejs"
	...
	INSTALL_AUTO_ARG="-y"
	INSTALL_QUIET_ARG="-q"
	INSTALL_PKG_LIST="git gcc gcc-c++ make procps k2hash-devel"
	NODEJS_PKG_LIST="nodejs"
